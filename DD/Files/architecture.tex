...
%TODO: 	customer enter store (and exit) Az
%		notification Ab
%		Customer open OnPremiseRes Az
%		Customer open FutureRes with web app Ab
%		StatisticManager generates statistics Az
%		StOwner register new store Ab
