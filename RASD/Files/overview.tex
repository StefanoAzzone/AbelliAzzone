...
\begin{enumerate}
	\item The stores have means to allow entrance or exit to customers that are authorized (e.g. QR/NFC).
	\item Outside stores a device can identify customers and print tickets.
